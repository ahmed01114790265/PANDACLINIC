        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "default-product.png"),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TypeOfAppoinment = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HostingStays", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HostingStays_Animals_AnimalId",
                        column: x => x.AnimalId,
                        principalTable: "Animals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HostingStays_AnimalId",
                table: "HostingStays",
                column: "AnimalId");

            migrationBuilder.CreateIndex(
                name: "IX_HostingStays_CheckOutDate",
                table: "HostingStays",
                column: "CheckOutDate");

            migrationBuilder.CreateIndex(
                name: "IX_HostingStays_RoomNumber",
                table: "HostingStays",
                column: "RoomNumber");
